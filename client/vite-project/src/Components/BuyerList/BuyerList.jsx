    ...
    useEffect(() => {
        const fetchSellerDetails = async () => {
            try {
                ...
                // const details = response.data?.totalSeller || []; // Default to empty array if undefined
                setSellers(response.data.totalBuyer );
            } catch (error) {
                    ...
                    <table className="min-w-full bg-white">
                        <thead>
                            <tr className="w-full bg-gray-800 text-white">
                                ...
                                <th className="py-2 px-4 text-left">Seller Detials</th>
                                ...
                                sellers.map((seller, index) => (
                                    <tr key={index} className="border-b">
                                        ...
                                        <td className="py-2 px-4" onClick={() => productDetails(seller._id)}>
                                            {seller.dateUpdated || "See Detials"}
                                        </td>
